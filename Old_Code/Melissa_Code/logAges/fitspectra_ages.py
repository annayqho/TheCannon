...
# This is a goodness_fit calculated for every star, comparing the input spectral flux with the dot product of (input parameters) & (generated coefficients)
def get_goodness_fit_inputparams(fn_pickle, params_file, coeffs_file):
...
# This is a goodness_fit calculated for every star, comparing the input spectral flux with the flux generated with (output parameters)*(coefficients)
def get_goodness_fit_inputparams(fn_pickle, params_file, coeffs_file):
    # should be 1. 'normed_data', 2. 'self_2nd_order_tags.pickle', 3. coeffs_2nd_order.pickle 
    # The goal is to compare (1) the input flux for a particular star/pixel combination with (2) the flux produced by the model given the generated spectral parameters
    ...
    #### Now, get the flux for a particular star/pixel combination in the spectrum generated by applying the model to the generated stellar parameters
