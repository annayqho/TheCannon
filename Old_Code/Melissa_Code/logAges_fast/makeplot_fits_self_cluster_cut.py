...
#    file_in = "self_tags.pickle"
    ...
    for i in range(0,len(cluster_ind)-1): 
      ...
      for ax, num,num2,label1,x1,y1 in zip(axs, listit_1,listit_2,labels, [4800,3.0,0.3,0.3], [3400,1,-1.5,5]): 
        if num == 3:
            print filenames[indc1:indc2][pick]
            print input_ASPCAP[num][indc1:indc2][pick], params_labels[num][indc1:indc2][pick], plot_markers[i]
    ...
    ax4.text(10.0,7.0,"y-axis, $<\sigma>$ = "+str(round(mean(params_labels[3+4]),5)),fontsize = 14)
