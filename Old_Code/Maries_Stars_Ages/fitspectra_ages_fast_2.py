"""
Training on Marie's stars, so things had to change...
...
def continuum_normalize_tsch(dataall, pixlist, delta_lambda=150):
    ...
    for jj in range(Nstar):
        ...
        #dataall_flat[bad,jj, 2] = LARGE
    print type(dataall_flat)
    print dataall_flat.shape
...
def get_normalized_training_data_tsch(pixlist):
    if glob.glob(normed_training_data):
        ...
        dataall, metaall, labels, ids = pickle.load(file_in2)
        file_in2.close()
        return dataall, metaall, labels, ids
    ...
    for jj,each in enumerate(file_list):
        ...
        if jj == 0:
            ...
            metaall = np.ones((len(file_list), nmeta))
        if jj > 0:
    ...
    pickle.dump((dataall, metaall, labels, ids), file_in)
    file_in.close()
...
if __name__ == "__main__":
    ...
    dataall, metaall, labels, ids = get_normalized_training_data_tsch(pixlist)
    #print "main method"
    #print "metaall size: "
    #print metaall.shape
