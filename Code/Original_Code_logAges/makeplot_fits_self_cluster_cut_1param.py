...
#    file_in = "self_tags.pickle"
    ...
    #ax.tick_params(labelcolor= 'w', top = 'on', bottom = 'on', left = 'off', right = 'off' ) 
    ...
    ax.set_xlim(8.5, 10.5)  # for log ages
    ax.set_ylim(8, 11) #for log ages 
    ax.set_ylabel("log(Age [Gyr])", fontsize = 14,labelpad = 5) 
    ax.set_xlabel("log(Literature Ages [Gyr])", fontsize = 14,labelpad = 10) 
