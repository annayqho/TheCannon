...
def get_goodness_fit(fn_pickle, params_file, coeffs_file):
    ...
    return chi2_def # probably return it without the sum, and then when you call it save those values to a .pickle file: pickle.dump((Params_all, covs_all,chi2_def,ids), file_in) -- being saved into self_2nd_order_tags.pickle 
