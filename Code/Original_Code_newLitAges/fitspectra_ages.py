...
def get_goodness_fit(inputdata, outputdata):
    # originally, this was 1. fn_pickle 'coeffs_2nd_order', 2. filein 'normed_data'
    # now it should be 1. 'starsin_SFD_Pleiades.txt' 2. 'normed_data'
    ...
    file_with_star_data = str(outputdata)+".pickle" #outputdata: normed_data.pickle
    ...
    for jj in range(nstars):
        ...
        # Above, data_star is our output data
