...
label_names = np.array([r'\mathrm{T}_{\mathrm{eff}}', r'\mathrm{log g}', 
r'[\frac{\mathrm{M}}{\mathrm{H}}]', r'[\frac{\mathrm{C}}{\mathrm{M}}]', 
...
plt.xlim(np.ma.min(wl), 5800)
plt.tick_params(axis='x', labelsize=14)
axarr[-1].locator_params(axis='x', nbins=10)

highs = [0.05, 0.016, 0.012, 0.008, 0.012, 0.02, 0.2]
lows = [-0.03, -0.018, -0.008, -0.009, -0.013, -0.02, -0.45]
errs = [91.5, 0.11, 0.05, 0.04, 0.07, 0.05, 1]
