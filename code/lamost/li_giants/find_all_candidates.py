...
if __name__=="__main__":
    ...
    LAB_DIR = "/Users/annaho/Data/LAMOST/Label_Transfer"
    ...
    print("loading model")
    coeffs, scatters, chisqs, pivots = get_model(LAB_DIR)
    model_spec = get_model_spec(
    ...
    obj = [1177,1417,1518,244,250,287,320,376,399,560,67,671,715,750,786,871]
    #ii = 376
    for ii in obj:
        spectral_model(
                ii, wl, flux[good], ivar[good], model_spec[good], 
